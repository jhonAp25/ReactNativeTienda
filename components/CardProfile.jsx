...
const CardProfile = () => {
    return (
        ...
        <View style={style.usuario}>
            <Text style={{color: '#F3F2C9', fontWeight: 'semibold' , fontSize: '1.5rem' , fontFamily : 'Roboto_700Bold',}} >Hola Jhon Apaza</Text>
            <Text style={{color: '#fff' ,fontSize: '1rem', fontWeight:'300', fontFamily : 'Roboto_100Thin', }} >Bienvenido de nuevo</Text>
        </View>
